<div>
   <h1 id="title">16_frak_complex</h1>
   <p id="paragraph">Ground Truth with a collection of documents with the following characteristics: 
font blackletter, two-columned, hand-written additions, stamps, partly tabular-like structures, labelled illustration, initial</p>
   <h2>Metadata</h2>
   <dl class="grid">
